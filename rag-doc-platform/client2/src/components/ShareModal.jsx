                ...
                >
                    <div className="rounded-[26px] border border-white/5 bg-[#101010]/95 p-6">
                        <div className="mb-6 flex items-start justify-between gap-4">
                            <div>
                                <p className="text-xs font-medium uppercase tracking-[0.24em] text-zinc-500">Share</p>
                                <h3 className="mt-2 text-2xl font-semibold text-zinc-100">Export This Chat</h3>
                                <p className="mt-2 text-sm leading-6 text-zinc-400">Create a shareable link or download your conversation.</p>
                            </div>
                            <button
                                onClick={onClose}
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="rounded-[24px] border border-zinc-800 bg-[#121212] p-4">
                                <label className="mb-3 block text-xs font-medium uppercase tracking-[0.2em] text-zinc-500">Shareable Link</label>
                                {loading ? (
                                    ...
                                    <div className="flex flex-col gap-3 sm:flex-row">
                                        ...
                                        <button
                                            ...
                                            className={`inline-flex items-center gap-2 rounded-2xl px-5 py-3 text-sm font-medium transition whitespace-nowrap ${copied ? 'bg-emerald-500 text-black' : 'bg-zinc-100 text-zinc-900 hover:bg-white'
                                                }`}
                                        >
                                            {copied ? (
                                                <>
                                ...
                                <p className="mt-3 text-xs leading-5 text-zinc-500">Shareable link expires in 30 days. Anyone with the link can view this conversation.</p>
                            </div>

                            {/* Export Options */}
                            <div className="rounded-[24px] border border-zinc-800 bg-[#121212] p-4">
                                <label className="mb-3 block text-xs font-medium uppercase tracking-[0.2em] text-zinc-500">Export Options</label>
